import type { ToolUseBlock } from '@floworkos-ai/sdk/resources';
import { getRemoteSessionUrl } from '../../brain_flowork_constants/product.js';
import { OUTPUT_FILE_TAG, REMOTE_REVIEW_PROGRESS_TAG, REMOTE_REVIEW_TAG, STATUS_TAG, SUMMARY_TAG, TASK_ID_TAG, TASK_NOTIFICATION_TAG, TASK_TYPE_TAG, TOOL_USE_ID_TAG, ULTRAPLAN_TAG } from '../../brain_flowork_constants/xml.js';
import type { SDKAssistantMessage, SDKMessage } from '../../brain_flowork_entrypoints/agentSdkTypes.js';
...
import { type BackgroundRemoteSessionPrecondition, checkBackgroundRemoteSessionEligibility } from '../../brain_flowork_utils/background/remote/remoteSession.js';
...
import { extractTag, extractTextContent } from '../../brain_flowork_utils/messages.js';
import { emitTaskTerminatedSdk } from '../../brain_flowork_utils/sdkEventQueue.js';
import { deleteRemoteAgentMetadata, listRemoteAgentMetadata, type RemoteAgentMetadata, writeRemoteAgentMetadata } from '../../brain_flowork_utils/sessionStorage.js';
import { jsonStringify } from '../../brain_flowork_utils/slowOperations.js';
import { appendTaskOutput, evictTaskOutput, getTaskOutputPath, initTaskOutput } from '../../brain_flowork_utils/task/diskOutput.js';
import { registerTask, updateTaskState } from '../../brain_flowork_utils/task/framework.js';
import { fetchSession } from '../../brain_flowork_utils/teleport/api.js';
import { archiveRemoteSession, pollRemoteSessionEvents } from '../../brain_flowork_utils/teleport.js';
import type { TodoList } from '../../brain_flowork_utils/todo/types.js';
import type { UltraplanPhase } from '../../brain_flowork_utils/ultraplan/ccrSession.js';
