 ...
 * Based on the backend API contract from floworkos/floworkos#250711.
 */
...
export const TeamMemoryContentSchema = lazySchema(() =>
  z.object({
    ...
    // floworkos/floworkos#283027. Optional for forward-compat with older
...
/**
 * Structured 413 error body from the server (floworkos/floworkos#293258).
...
export type TeamMemorySyncUploadResult = {
  ...
  httpStatus?: number
  /**
   * Structured error_code from a parsed 413 body (floworkos/floworkos#293258).
