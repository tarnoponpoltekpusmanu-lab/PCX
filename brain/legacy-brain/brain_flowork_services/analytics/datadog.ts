...
import { MODEL_COSTS } from '../../brain_flowork_utils/modelCost.js'
...
export async function trackDatadogEvent(
  ...
  try {
    ...
    const log: DatadogLog = {
      ...
      ddtags: tags.join(','),
      message: eventName,
      service: 'flowork-engine',
      hostname: 'flowork-engine',
...
function getFlushIntervalMs(): number {
  ...
  return (
    parseInt(process.env.FLOWORK_ENGINE_DATADOG_FLUSH_INTERVAL_MS || '', 10) ||
