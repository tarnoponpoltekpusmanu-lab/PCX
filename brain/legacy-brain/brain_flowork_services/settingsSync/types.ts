 ...
 * Based on the backend API contract from floworkos/floworkos#218817.
 */
...
export const SYNC_KEYS = {
  USER_SETTINGS: '~/.flowork/settings.json',
  USER_MEMORY: '~/.flowork/FLOWORK.md',
  projectSettings: (projectId: string) =>
    `projects/${projectId}/.flowork/settings.local.json`,
