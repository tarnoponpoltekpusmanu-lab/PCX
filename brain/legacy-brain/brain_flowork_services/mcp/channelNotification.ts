...
import { type ChannelEntry, getAllowedChannels } from '../../brain_flowork_bootstrap/state.js'
import { CHANNEL_TAG } from '../../brain_flowork_constants/xml.js'
import {
  getClaudeAIOAuthTokens,
  getSubscriptionType,
} from '../../brain_flowork_utils/auth.js'
import { lazySchema } from '../../brain_flowork_utils/lazySchema.js'
import { parsePluginIdentifier } from '../../brain_flowork_utils/plugins/pluginIdentifier.js'
import { getSettingsForSource } from '../../brain_flowork_utils/settings/settings.js'
import { escapeXmlAttr } from '../../brain_flowork_utils/xml.js'
import {
...
export function gateChannelServer(
  ...
  if (entry.kind === 'plugin') {
    // Marketplace verification: the tag is intent (plugin:slack@floworkos),
    // the runtime name is just plugin:slack:X — could be slack@floworkos or
