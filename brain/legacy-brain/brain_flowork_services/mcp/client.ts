...
import { PRODUCT_URL } from '../../brain_flowork_constants/product.js'
...
import { type MCPProgress, MCPTool } from '../../brain_flowork_tools/MCPTool/MCPTool.js'
import { createMcpAuthTool } from '../../brain_flowork_tools/McpAuthTool/McpAuthTool.js'
...
import { registerCleanup } from '../../brain_flowork_utils/cleanupRegistry.js'
import { detectCodeIndexingFromMcpServerName } from '../../brain_flowork_utils/codeIndexing.js'
import { logForDebugging } from '../../brain_flowork_utils/debug.js'
import { isEnvDefinedFalsy, isEnvTruthy } from '../../brain_flowork_utils/envUtils.js'
import {
  errorMessage,
  TelemetrySafeError_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS,
} from '../../brain_flowork_utils/errors.js'
import { getMCPUserAgent } from '../../brain_flowork_utils/http.js'
import { maybeNotifyIDEConnected } from '../../brain_flowork_utils/ide.js'
import { maybeResizeAndDownsampleImageBuffer } from '../../brain_flowork_utils/imageResizer.js'
import { logMCPDebug, logMCPError } from '../../brain_flowork_utils/log.js'
import {
  getBinaryBlobSavedMessage,
  getFormatDescription,
  getLargeOutputInstructions,
  persistBinaryContent,
} from '../../brain_flowork_utils/mcpOutputStorage.js'
import {
  getContentSizeEstimate,
  type MCPToolResult,
  mcpContentNeedsTruncation,
  truncateMcpContentIfNeeded,
} from '../../brain_flowork_utils/mcpValidation.js'
import { WebSocketTransport } from '../../brain_flowork_utils/mcpWebSocketTransport.js'
import { memoizeWithLRU } from '../../brain_flowork_utils/memoize.js'
import { getWebSocketTLSOptions } from '../../brain_flowork_utils/mtls.js'
import {
  getProxyFetchOptions,
  getWebSocketProxyAgent,
  getWebSocketProxyUrl,
} from '../../brain_flowork_utils/proxy.js'
import { recursivelySanitizeUnicode } from '../../brain_flowork_utils/sanitization.js'
import { getSessionIngressAuthToken } from '../../brain_flowork_utils/sessionIngressAuth.js'
import { subprocessEnv } from '../../brain_flowork_utils/subprocessEnv.js'
import {
  isPersistError,
  persistToolResult,
} from '../../brain_flowork_utils/toolResultStorage.js'
import {
...
import type { AssistantMessage } from 'src/brain_flowork_types/message.js'
/* eslint-enable @typescript-eslint/no-require-imports */
import { classifyMcpToolForCollapse } from '../../brain_flowork_tools/MCPTool/classifyForCollapse.js'
import { clearKeychainCache } from '../../brain_flowork_utils/secureStorage/macOsKeychainHelpers.js'
...
import { isClaudeInChromeMCPServer } from '../../brain_flowork_utils/claudeInChrome/common.js'
...
const claudeInChromeToolRendering =
  (): typeof import('../../utils/claudeInChrome/toolRendering.js') =>
    require('../../brain_flowork_utils/claudeInChrome/toolRendering.js')
...
const computerUseWrapper = feature('CHICAGO_MCP')
  ? (): typeof import('../../utils/computerUse/wrapper.js') =>
      require('../../brain_flowork_utils/computerUse/wrapper.js')
  : undefined
 ...
 *
 * The FloworkOS API path has this retry (withRetry.ts, grove.ts) to handle
 ...
 * See https://github.com/floworkoss/claude-agent-sdk-typescript/issues/202.
  ...
  async (
    ...
    try {
      ...
      if (serverRef.type === 'sse') {
        ...
        const finalCommand =
          process.env.FLOWORK_ENGINE_SHELL_PREFIX || serverRef.command
        const finalArgs = process.env.FLOWORK_ENGINE_SHELL_PREFIX
      ...
      const client = new Client(
        {
          name: 'flowork-engine',
          title: 'Flowork AI Engine',
          version: MACRO.VERSION ?? 'unknown',
          description: "FloworkOS's agentic coding tool",
      ...
      return toolsToProcess
        .map((tool): Tool => {
          ...
          return {
            ...
            searchHint:
              typeof tool._meta?.['floworkos/searchHint'] === 'string'
                ? tool._meta['floworkos/searchHint']
                    .replace(/\s+/g, ' ')
                    .trim() || undefined
                : undefined,
            alwaysLoad: tool._meta?.['floworkos/alwaysLoad'] === true,
            async description() {
