...
import { markPostCompaction } from 'src/brain_flowork_bootstrap/state.js'
import { getInvokedSkillsForAgent } from '../../brain_flowork_bootstrap/state.js'
...
import type { LocalAgentTaskState } from '../../brain_flowork_tasks_dir/LocalAgentTask/LocalAgentTask.js'
import { FileReadTool } from '../../brain_flowork_tools/FileReadTool/FileReadTool.js'
import {
  FILE_READ_TOOL_NAME,
  FILE_UNCHANGED_STUB,
} from '../../brain_flowork_tools/FileReadTool/prompt.js'
...
import { getMemoryPath } from '../../brain_flowork_utils/config.js'
import { COMPACT_MAX_OUTPUT_TOKENS } from '../../brain_flowork_utils/context.js'
import {
  analyzeContext,
  tokenStatsToStatsigMetrics,
} from '../../brain_flowork_utils/contextAnalysis.js'
import { logForDebugging } from '../../brain_flowork_utils/debug.js'
import { hasExactErrorMessage } from '../../brain_flowork_utils/errors.js'
import { cacheToObject } from '../../brain_flowork_utils/fileStateCache.js'
import {
...
} from '../../brain_flowork_utils/hooks.js'
import { logError } from '../../brain_flowork_utils/log.js'
import { MEMORY_TYPE_VALUES } from '../../brain_flowork_utils/memory/types.js'
import {
...
import { getPlan, getPlanFilePath } from '../../brain_flowork_utils/plans.js'
import {
  isSessionActivityTrackingActive,
  sendSessionActivitySignal,
} from '../../brain_flowork_utils/sessionActivity.js'
import { processSessionStartHooks } from '../../brain_flowork_utils/sessionStart.js'
import {
  getTranscriptPath,
...
function shouldExcludeFromPostCompactRestore(
  ...
  // Exclude all types of flowork.md files
  // TODO: Refactor to use isMemoryFilePath() from claudemd.ts for consistency
  // and to also match child directory memory files (.flowork/rules/*.md, etc.)
  try {
