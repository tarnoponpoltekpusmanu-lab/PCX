...
import { getContextWindowForModel } from '../../brain_flowork_utils/context.js'
...
export function getEffectiveContextWindowSize(model: string): number {
  ...
  const autoCompactWindow = process.env.FLOWORK_ENGINE_AUTO_COMPACT_WINDOW
...
export function calculateTokenWarningState(
  ...
  const blockingLimitOverride = process.env.FLOWORK_ENGINE_BLOCKING_LIMIT_OVERRIDE
