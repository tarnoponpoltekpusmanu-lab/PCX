...
import { getErrnoCode, toError } from '../../brain_flowork_utils/errors.js'
...
Based on the user conversation above (EXCLUDING this note-taking instruction message as well as system prompt, flowork.md entries, or any past session summaries), update the session notes file.
...
- Do not include information that's already in the FLOWORK.md files included in the context
 ...
 * Custom prompts can be placed at ~/.flowork/session-memory/prompt.md
