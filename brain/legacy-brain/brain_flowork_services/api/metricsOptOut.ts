...
import { hasProfileScope, isClaudeAISubscriber } from '../../brain_flowork_utils/auth.js'
...
import { getAuthHeaders, withOAuth401Retry } from '../../brain_flowork_utils/http.js'
import { logError } from '../../brain_flowork_utils/log.js'
import { memoizeWithTTLAsync } from '../../brain_flowork_utils/memoize.js'
...
async function _fetchMetricsEnabled(): Promise<MetricsEnabledResponse> {
  ...
  const endpoint = `https://api.floworkos.com/api/claude_code/organizations/metrics_enabled`
