import type { BetaToolUnion } from '@floworkos-ai/sdk/resources/beta/messages/messages.mjs'
...
import type { Message } from 'src/brain_flowork_types/message.js'
import { logForDebugging } from 'src/brain_flowork_utils/debug.js'
import { djb2Hash } from 'src/brain_flowork_utils/hash.js'
import { logError } from 'src/brain_flowork_utils/log.js'
import { getClaudeTempDir } from 'src/brain_flowork_utils/permissions/filesystem.js'
...
type PreviousState = {
   ...
   *  or floworkos_internal.effort_override. */
  effortValue: string
  /** Hash of getExtraBodyParams() — catches FLOWORK_ENGINE_EXTRA_BODY and
   *  floworkos_internal changes. */
...
// FloworkOS's server-side prompt cache TTL thresholds to test.
