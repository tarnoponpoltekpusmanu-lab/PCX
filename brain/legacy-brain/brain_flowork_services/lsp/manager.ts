...
import { isBareMode } from '../../brain_flowork_utils/envUtils.js'
 ...
 * Initialized during Flowork AI Engine startup.
 */
 ...
 * asynchronously during Flowork AI Engine startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Flowork AI Engine startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/floworkoss/flowork-engine/issues/15521:
 ...
 *
 * This should be called during Flowork AI Engine shutdown. Stops all running LSP servers
