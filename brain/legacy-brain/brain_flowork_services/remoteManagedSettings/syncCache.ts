...
import { CLAUDE_AI_INFERENCE_SCOPE } from '../../brain_flowork_constants/oauth.js'
import {
 ...
 *   FLOWORK_ENGINE_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  if (!isFirstPartyFloworkOSBaseUrl()) {
    return (cached = setEligibility(false))
  }
  ...
  // Externally-injected tokens (CCD via FLOWORK_ENGINE_OAUTH_TOKEN, CCR via
  // FLOWORK_ENGINE_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
