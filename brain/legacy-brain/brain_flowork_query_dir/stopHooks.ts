...
import { getTaskListId, listTasks } from '../brain_flowork_utils/tasks.js'
import { getAgentName, getTeamName, isTeammate } from '../brain_flowork_utils/teammate.js'
...
import { executeAutoDream } from '../brain_flowork_services/autoDream/autoDream.js'
import { executePromptSuggestion } from '../brain_flowork_services/PromptSuggestion/promptSuggestion.js'
import { isBareMode, isEnvDefinedFalsy } from '../brain_flowork_utils/envUtils.js'
import {
...
> {
  ...
  if (!isBareMode()) {
    ...
    if (!isEnvDefinedFalsy(process.env.FLOWORK_ENGINE_ENABLE_PROMPT_SUGGESTION)) {
