...
} from '../brain_flowork_plugins/pluginIdentifier.js'
 ...
 * marketplace-origin.
 *
 * - official: from an allowlisted FloworkOS marketplace
...
export function buildPluginTelemetryFields(
  ...
  // Both official marketplaces and builtin plugins are FloworkOS-controlled
  // — safe to expose real names in the redacted columns.
  const isFloworkOSControlled =
  ...
  return {
    ...
    plugin_name_redacted: (isFloworkOSControlled
      ? name
      : 'third-party') as AnalyticsMetadata_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS,
    marketplace_name_redacted: (isFloworkOSControlled && marketplace
      ? marketplace
      : 'third-party') as AnalyticsMetadata_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS,
    is_official_plugin: isFloworkOSControlled,
  }
}
