 ...
 *
 * Scans ~/.flowork/teams/ to find teams where the current session is the leader.
...
// Note: For time formatting, use formatRelativeTimeAgo from '../brain_flowork_utils/format.js'
