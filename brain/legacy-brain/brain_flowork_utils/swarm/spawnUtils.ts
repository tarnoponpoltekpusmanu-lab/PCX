...
const TEAMMATE_ENV_VARS = [
  ...
  // its own way via /home/claude/.flowork/remote/.oauth_token regardless;
  // the FD env var wouldn't help (pipe FDs don't cross tmux).
  'FLOWORK_ENGINE_REMOTE',
  ...
  'FLOWORK_ENGINE_REMOTE_MEMORY_DIR',
 ...
 * Always includes CLAUDECODE=1 and FLOWORK_ENGINE_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['CLAUDECODE=1', 'FLOWORK_ENGINE_EXPERIMENTAL_AGENT_TEAMS=1']
