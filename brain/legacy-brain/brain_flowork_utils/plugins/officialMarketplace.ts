/**
 * Constants for the official FloworkOS plugins marketplace.
 *
 * The official marketplace is hosted on GitHub and provides first-party
 * plugins developed by FloworkOS. This file defines the constants needed
...
/**
 * Source configuration for the official FloworkOS plugins marketplace.
 * Used when auto-installing the marketplace on startup.
 */
export const OFFICIAL_MARKETPLACE_SOURCE = {
  source: 'github',
  repo: 'floworkoss/claude-plugins-official',
