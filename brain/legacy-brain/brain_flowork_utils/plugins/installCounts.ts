 ...
 * than 24 hours.
 *
 * Cache location: ~/.flowork/plugins/install-counts-cache.json
 */
...
const INSTALL_COUNTS_URL =
  'https://raw.githubusercontent.com/floworkoss/claude-plugins-official/refs/heads/stats/stats/plugin-installs.json'
