/**
 * Auto-install logic for the official FloworkOS marketplace.
 *
...
export function isOfficialMarketplaceAutoInstallDisabled(): boolean {
  return isEnvTruthy(
    process.env.FLOWORK_ENGINE_DISABLE_OFFICIAL_MARKETPLACE_AUTOINSTALL,
  )
}
...
export async function checkAndInstallOfficialMarketplace(): Promise<OfficialMarketplaceCheckResult> {
  ...
  try {
    ...
    // Backend (floworkos#317037) publishes a marketplace zip to the same
