 ...
 * - Layer 2: materialization (~/.flowork/plugins/) — reconcileMarketplaces()
...
import { reinitializeLspServerManager } from '../../brain_flowork_services/lsp/manager.js'
...
import { getAgentDefinitionsWithOverrides } from '../../brain_flowork_tools/AgentTool/loadAgentsDir.js'
