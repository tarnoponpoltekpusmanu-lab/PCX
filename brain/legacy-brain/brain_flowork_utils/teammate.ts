 ...
 *
 * These helpers identify whether this Flowork AI Engine instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.FLOWORK_ENGINE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our FLOWORK_ENGINE_AGENT_ID matches the leadAgentId, OR
 *    - We have no FLOWORK_ENGINE_AGENT_ID set (backwards compat: the original
