import { normalizeNameForMCP } from '../../brain_flowork_services/mcp/normalization.js'
import { env } from '../env.js'

export const COMPUTER_USE_MCP_SERVER_NAME = 'computer-use'

/**
 * Sentinel bundle ID for the frontmost gate. Flowork AI Engine is a terminal — it has
 ...
 */
export const CLI_HOST_BUNDLE_ID = 'com.floworkos.flowork-engine.cli-no-window'
