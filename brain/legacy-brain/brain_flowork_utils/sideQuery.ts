...
import { STRUCTURED_OUTPUTS_BETA_HEADER } from '../brain_flowork_constants/betas.js'
...
import { getAPIMetadata } from '../brain_flowork_services/api/claude.js'
import { getFloworkOSClient } from '../brain_flowork_services/api/client.js'
import { getModelBetas, modelSupportsStructuredOutputs } from './betas.js'
import { computeFingerprint } from './fingerprint.js'
import { normalizeModelStringForAPI } from './model/model.js'

type MessageParam = FloworkOS.MessageParam
type TextBlockParam = FloworkOS.TextBlockParam
type Tool = FloworkOS.Tool
type ToolChoice = FloworkOS.ToolChoice
type BetaMessage = FloworkOS.Beta.Messages.BetaMessage
type BetaJSONOutputFormat = FloworkOS.Beta.Messages.BetaJSONOutputFormat
type BetaThinkingConfigParam = FloworkOS.Beta.Messages.BetaThinkingConfigParam
...
export async function sideQuery(opts: SideQueryOptions): Promise<BetaMessage> {
  ...
  const client = await getFloworkOSClient({
    maxRetries,
    model,
    source: 'side_query',
  })
