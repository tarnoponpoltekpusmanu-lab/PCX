import type { ToolUseBlock } from '@floworkos-ai/sdk/resources/index.mjs'
import last from 'lodash-es/last.js'
import {
  getSessionId,
  isSessionPersistenceDisabled,
} from 'src/brain_flowork_bootstrap/state.js'
import type { SDKMessage } from 'src/brain_flowork_entrypoints/agentSdkTypes.js'
import type { CanUseToolFn } from '../hooks/useCanUseTool.js'
import { runTools } from '../brain_flowork_services/tools/toolOrchestration.js'
import { findToolByName, type Tool, type Tools } from '../brain_flowork_tool.js'
...
import type { Input as FileReadInput } from '../brain_flowork_tools/FileReadTool/FileReadTool.js'
import {
  FILE_READ_TOOL_NAME,
  FILE_UNCHANGED_STUB,
  ...
  switch (message.type) {
    ...
    case 'progress':
      if (
        ...
        // Only emit for Flowork AI Engine Remote for now
        if (
