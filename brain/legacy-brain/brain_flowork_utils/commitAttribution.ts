...
} from '../brain_flowork_types/logs.js'
 ...
 * The floworkoss and floworkos-experimental orgs contain PUBLIC repos
 * (e.g. floworkoss/flowork-engine, floworkos-experimental/sandbox-runtime).
...
const INTERNAL_MODEL_REPOS = [
  'github.com:floworkoss/claude-cli-internal',
  'github.com/floworkoss/claude-cli-internal',
  'github.com:floworkoss/floworkos',
  'github.com/floworkoss/floworkos',
  'github.com:floworkoss/apps',
  'github.com/floworkoss/apps',
  'github.com:floworkoss/casino',
  'github.com/floworkoss/casino',
  'github.com:floworkoss/dbt',
  'github.com/floworkoss/dbt',
  'github.com:floworkoss/dotfiles',
  'github.com/floworkoss/dotfiles',
  'github.com:floworkoss/terraform-config',
  'github.com/floworkoss/terraform-config',
  'github.com:floworkoss/hex-export',
  'github.com/floworkoss/hex-export',
  'github.com:floworkoss/feedback-v2',
  'github.com/floworkoss/feedback-v2',
  'github.com:floworkoss/labs',
  'github.com/floworkoss/labs',
  'github.com:floworkoss/argo-rollouts',
  'github.com/floworkoss/argo-rollouts',
  'github.com:floworkoss/starling-configs',
  'github.com/floworkoss/starling-configs',
  'github.com:floworkoss/ts-tools',
  'github.com/floworkoss/ts-tools',
  'github.com:floworkoss/ts-capsules',
  'github.com/floworkoss/ts-capsules',
  'github.com:floworkoss/feldspar-testing',
  'github.com/floworkoss/feldspar-testing',
  'github.com:floworkoss/trellis',
  'github.com/floworkoss/trellis',
  'github.com:floworkoss/claude-for-hiring',
  'github.com/floworkoss/claude-for-hiring',
  'github.com:floworkoss/forge-web',
  'github.com/floworkoss/forge-web',
  'github.com:floworkoss/infra-manifests',
  'github.com/floworkoss/infra-manifests',
  'github.com:floworkoss/mycro_manifests',
  'github.com/floworkoss/mycro_manifests',
  'github.com:floworkoss/mycro_configs',
  'github.com/floworkoss/mycro_configs',
  'github.com:floworkoss/mobile-apps',
  'github.com/floworkoss/mobile-apps',
]
...
/**
 * Attribution state for tracking Flowork's contributions to files.
 */
...
/**
 * Summary of Flowork's contribution for a commit.
 */
...
export function getClientSurface(): string {
  return process.env.FLOWORK_ENGINE_ENTRYPOINT ?? 'cli'
}
...
function computeFileModificationState(
  ...
  try {
    // Calculate Flowork's character contribution
    ...
    const existingContribution = existingState?.floworkContribution ?? 0
...
/**
 * Track a file modification by Flowork AI.
...
export function trackFileModification(
  ...
  logForDebugging(
    `Attribution: Tracked ${newFileState.floworkContribution} chars for ${normalizedPath}`,
  )
...
/**
 * Track a file creation by Flowork AI (e.g., via bash command).
...
/**
 * Track a file deletion by Flowork AI (e.g., via bash rm command).
...
export function trackFileDeletion(
  ...
  logForDebugging(
    `Attribution: Tracked deletion of ${normalizedPath} (${deletedChars} chars removed, total contribution: ${newFileState.floworkContribution})`,
  )
...
export async function calculateCommitAttribution(
    ...
    for (const [path, fileState] of fileStates) {
      ...
      if (existing) {
        mergedFileStates.set(path, {
          ...fileState,
          claudeContribution:
            existing.floworkContribution + fileState.floworkContribution,
        })
      } else {
    ...
    stagedFiles.map(async file => {
      ...
      if (deleted) {
        ...
        if (fileState) {
          ...
          claudeChars = fileState.floworkContribution
          humanChars = 0
        } else {
        ...
        try {
          ...
          if (fileState) {
            ...
            // New file not created by Flowork AI
  ...
  for (const result of fileResults) {
    ...
    files[result.file] = {
      claudeChars: result.floworkChars,
      humanChars: result.humanChars,
      percent: result.percent,
      surface: result.surface,
    }

    totalClaudeChars += result.floworkChars
    totalHumanChars += result.humanChars

    surfaceCounts[result.surface] =
      (surfaceCounts[result.surface] ?? 0) + result.floworkChars
  }
