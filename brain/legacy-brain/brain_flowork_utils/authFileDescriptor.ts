 ...
 * /home/claude/.flowork/remote/ and will (eventually) write these files too.
 ...
 */
const CCR_TOKEN_DIR = '/home/claude/.flowork/remote'
 ...
 * rationale. Env var: FLOWORK_ENGINE_OAUTH_TOKEN_FILE_DESCRIPTOR.
 * Well-known file: /home/claude/.flowork/remote/.oauth_token.
 */
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'FLOWORK_ENGINE_OAUTH_TOKEN_FILE_DESCRIPTOR',
 ...
 * rationale. Env var: FLOWORK_ENGINE_API_KEY_FILE_DESCRIPTOR.
 * Well-known file: /home/claude/.flowork/remote/.api_key.
 */
export function getApiKeyFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'FLOWORK_ENGINE_API_KEY_FILE_DESCRIPTOR',
