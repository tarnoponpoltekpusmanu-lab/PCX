import type { McpbManifest } from '@floworkos-ai/mcpb'
 ...
 *
 * Lazy-imports @floworkos-ai/mcpb: that package uses zod v3 which eagerly
...
export async function validateManifest(
  ...
  const { McpbManifestSchema } = await import('@floworkos-ai/mcpb')
