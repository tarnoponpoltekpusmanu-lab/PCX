...
export function getAllHooks(appState: AppState): IndividualHookConfig[] {
  ...
  if (!restrictedToManagedOnly) {
    ...
    // both resolve to ~/.flowork/settings.json)
...
export function hookSourceDescriptionDisplayString(source: HookSource): string {
  switch (source) {
    case 'userSettings':
      return 'User settings (~/.flowork/settings.json)'
    case 'projectSettings':
      return 'Project settings (.flowork/settings.json)'
    case 'localSettings':
      return 'Local settings (.flowork/settings.local.json)'
    case 'pluginHook':
      ...
      // e.g., "Plugin hooks (~/.flowork/plugins/repos/source/example-plugin/example-plugin/hooks/hooks.json)"
      return 'Plugin hooks (~/.flowork/plugins/*/hooks/hooks.json)'
    case 'sessionHook':
      return 'Session hooks (in-memory, temporary)'
    case 'builtinHook':
      return 'Built-in hooks (registered internally by Flowork AI Engine)'
    default:
