...
import { queryModelWithoutStreaming } from '../../brain_flowork_services/api/claude.js'
import { getEmptyToolPermissionContext } from '../../brain_flowork_tool.js'
...
export async function applySkillImprovement(
  ...
  // Skills live at .flowork/skills/<name>/SKILL.md relative to CWD
  const filePath = join(getCwd(), '.flowork', 'skills', skillName, 'SKILL.md')
