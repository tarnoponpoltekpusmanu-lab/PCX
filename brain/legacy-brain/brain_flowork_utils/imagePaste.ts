...
import { getImageProcessor } from '../brain_flowork_tools/FileReadTool/imageProcessor.js'
...
function getClipboardCommands() {
  ...
  // Use FLOWORK_ENGINE_TMPDIR if set, otherwise fall back to platform defaults
  const baseTmpDir =
