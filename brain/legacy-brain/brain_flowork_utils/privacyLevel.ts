 ...
 *   FLOWORK_ENGINE_DISABLE_NONESSENTIAL_TRAFFIC  →  essential-traffic
...
export function getPrivacyLevel(): PrivacyLevel {
  if (process.env.FLOWORK_ENGINE_DISABLE_NONESSENTIAL_TRAFFIC) {
 ...
 * Equivalent to the old `process.env.FLOWORK_ENGINE_DISABLE_NONESSENTIAL_TRAFFIC` check.
 */
...
export function getEssentialTrafficOnlyReason(): string | null {
  if (process.env.FLOWORK_ENGINE_DISABLE_NONESSENTIAL_TRAFFIC) {
    return 'FLOWORK_ENGINE_DISABLE_NONESSENTIAL_TRAFFIC'
  }
  return null
}
