...
import { registerHookCallbacks } from '../brain_flowork_bootstrap/state.js'
import type { HookInput, HookJSONOutput } from '../brain_flowork_entrypoints/agentSdkTypes.js'
import {
...
import { inputSchema as editInputSchema } from '../brain_flowork_tools/FileEditTool/types.js'
...
import type { HookCallback } from '../brain_flowork_types/hooks.js'
import {
...
const teamMemWatcher = feature('TEAMMEM')
  ? (require('../brain_flowork_services/teamMemorySync/watcher.js') as typeof import('../services/teamMemorySync/watcher.js'))
  : null
const memoryShapeTelemetry = feature('MEMORY_SHAPE_TELEMETRY')
  ? (require('../brain_flowork_memdir/memoryShapeTelemetry.js') as typeof import('../memdir/memoryShapeTelemetry.js'))
  : null
