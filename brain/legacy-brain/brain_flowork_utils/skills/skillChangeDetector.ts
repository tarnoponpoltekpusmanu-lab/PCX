...
import { getAdditionalDirectoriesForClaudeMd } from '../../brain_flowork_bootstrap/state.js'
import {
...
async function getWatchablePaths(): Promise<string[]> {
  ...
  // User skills directory (~/.flowork/skills)
  ...
  // User commands directory (~/.flowork/commands)
  ...
  // Project skills directory (.flowork/skills)
  ...
  // Project commands directory (.flowork/commands)
  ...
  for (const dir of getAdditionalDirectoriesForClaudeMd()) {
    const additionalSkillsPath = platformPath.join(dir, '.flowork', 'skills')
    try {
