 ...
 *
 * Each teammate has an inbox file at .flowork/teams/{team_name}/inboxes/{agent_name}.json
...
import { PermissionModeSchema } from '../brain_flowork_entrypoints/sdk/coreSchemas.js'
...
import { sanitizePathComponent } from './brain_flowork_tasks.js'
 ...
 * Structure: ~/.flowork/teams/{team_name}/inboxes/{agent_name}.json
 */
 ...
 * @param teamName - Optional team name (defaults to FLOWORK_ENGINE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's FLOWORK_ENGINE_AGENT_ID */
  workerId: string
  /** Worker's FLOWORK_ENGINE_AGENT_NAME */
  workerName: string
  /** Worker's FLOWORK_ENGINE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to FLOWORK_ENGINE_TEAM_NAME env var)
