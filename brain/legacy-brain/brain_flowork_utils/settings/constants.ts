import { getAllowedSettingSources } from '../../brain_flowork_bootstrap/state.js'
...
/**
 * The JSON Schema URL for Flowork AI Engine settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/flowork-engine-settings.json
 */
export const FLOWORK_ENGINE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/flowork-engine-settings.json'
