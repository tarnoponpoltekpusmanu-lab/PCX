...
import { fileSuffixForOauthConfig } from '../brain_flowork_constants/oauth.js'
...
export const getGlobalClaudeFile = memoize((): string => {
  ...
  const filename = `.flowork${fileSuffixForOauthConfig()}.json`
 ...
 * If FLOWORK_ENGINE_HOST_PLATFORM is set to a valid platform value, that overrides
...
export function getHostPlatformForAnalytics(): Platform {
  const override = process.env.FLOWORK_ENGINE_HOST_PLATFORM
