...
export function getAgentModel(
  ...
  if (process.env.FLOWORK_ENGINE_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.FLOWORK_ENGINE_SUBAGENT_MODEL)
  }
  ...
  // region prefix (e.g., "eu.floworkos.…"), we preserve it instead of overwriting
 ...
 * See https://github.com/floworkoss/flowork-engine/issues/30815.
 *
