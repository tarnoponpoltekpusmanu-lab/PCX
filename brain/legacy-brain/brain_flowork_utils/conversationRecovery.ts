...
import { addInvokedSkill } from '../brain_flowork_bootstrap/state.js'
...
import { PERMISSION_MODES } from '../brain_flowork_types/permissions.js'
...
const SEND_USER_FILE_TOOL_NAME: string | null = feature('KAIROS')
  ? (
      require('../brain_flowork_tools/SendUserFileTool/prompt.js') as typeof import('../tools/SendUserFileTool/prompt.js')
