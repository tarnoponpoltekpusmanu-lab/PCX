...
import { isAgentMemoryPath } from '../brain_flowork_tools/AgentTool/agentMemory.js'
...
/**
 * Detects if a file path is a session-related file under ~/.flowork.
 ...
 * Excludes: FLOWORK.md, CLAUDE.local.md, .flowork/rules/*.md (user-managed).
 *
...
// Excludes FLOWORK.md, CLAUDE.local.md, .flowork/rules/ (user-managed).
