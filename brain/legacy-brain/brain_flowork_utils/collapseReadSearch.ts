...
import { findToolByName, type Tools } from '../brain_flowork_tool.js'
import { extractBashCommentLabel } from '../brain_flowork_tools/BashTool/commentLabel.js'
...
import { getReplPrimitiveTools } from '../brain_flowork_tools/REPLTool/primitiveTools.js'
import {
  type BranchAction,
  type CommitKind,
  detectGitOperation,
  type PrAction,
} from '../brain_flowork_tools/shared/gitOperationTracking.js'
...
const SNIP_TOOL_NAME = feature('HISTORY_SNIP')
  ? (
      require('../brain_flowork_tools/SnipTool/prompt.js') as typeof import('../tools/SnipTool/prompt.js')
    ).SNIP_TOOL_NAME
  : null
