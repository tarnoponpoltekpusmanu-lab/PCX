 ...
 * variables instead: FLOWORK_ENGINE_AGENT_ID, FLOWORK_ENGINE_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from FLOWORK_ENGINE_PARENT_SESSION_ID env var), undefined for main REPL subagents */
