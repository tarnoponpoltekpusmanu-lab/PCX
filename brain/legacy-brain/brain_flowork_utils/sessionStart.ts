import { getMainThreadAgentType } from '../brain_flowork_bootstrap/state.js'
import type { HookResultMessage } from '../brain_flowork_types/message.js'
...
import { loadPluginHooks } from './brain_flowork_plugins/loadPluginHooks.js'
  ...
  if (shouldAllowManagedHooksOnly()) {
    ...
    try {
      ...
      if (
        ...
        userGuidance =
          'This appears to be a permissions issue. Check file permissions on ~/.flowork/plugins/'
      } else if (
        ...
        userGuidance =
          'This appears to be a configuration issue. Check your plugin settings in .flowork/settings.json'
      } else {
        userGuidance =
      ...
      // from .flowork/settings.json (loaded via captureHooksConfigSnapshot) will still work
    }
  }
