...
export function registerClaudeApiSkill(): void {
  registerBundledSkill({
    name: 'claude-api',
    description:
      'Build apps with the Claude API or FloworkOS SDK.\n' +
      'TRIGGER when: code imports `floworkos`/`@floworkos-ai/sdk`/`claude_agent_sdk`, or user asks to use Claude API, FloworkOS SDKs, or Agent SDK.\n' +
