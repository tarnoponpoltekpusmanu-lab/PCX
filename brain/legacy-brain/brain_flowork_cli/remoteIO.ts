...
import { getPollIntervalConfig } from '../brain_flowork_bridge/pollConfig.js'
import { registerCleanup } from '../brain_flowork_utils/cleanupRegistry.js'
import { setCommandLifecycleListener } from '../brain_flowork_utils/commandLifecycle.js'
import { isDebugMode, logForDebugging } from '../brain_flowork_utils/debug.js'
...
import { writeToStdout } from '../brain_flowork_utils/process.js'
...
export class RemoteIO extends StructuredIO {
  ...
  constructor(
    ...
    const erVersion = process.env.FLOWORK_ENGINE_ENVIRONMENT_RUNNER_VERSION
    if (erVersion) {
    ...
    const refreshHeaders = (): Record<string, string> => {
      ...
      const freshErVersion = process.env.FLOWORK_ENGINE_ENVIRONMENT_RUNNER_VERSION
      if (freshErVersion) {
    ...
    this.isBridge = process.env.FLOWORK_ENGINE_ENVIRONMENT_KIND === 'bridge'
