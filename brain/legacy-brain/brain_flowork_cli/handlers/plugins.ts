...
import { setUseCoworkPlugins } from '../../brain_flowork_bootstrap/state.js'
import {
...
import {
  ...
  VALID_UPDATE_SCOPES,
} from '../../brain_flowork_services/plugins/pluginCliCommands.js'
...
import { getInstallCounts } from '../../brain_flowork_utils/plugins/installCounts.js'
import {
  isPluginInstalled,
...
} from '../../brain_flowork_utils/plugins/marketplaceHelpers.js'
import {
...
import { loadPluginMcpServers } from '../../brain_flowork_utils/plugins/mcpPluginIntegration.js'
import { parseMarketplaceInput } from '../../brain_flowork_utils/plugins/parseMarketplaceInput.js'
import {
...
import type { PluginSource } from '../../brain_flowork_utils/plugins/schemas.js'
import {
  type ValidationResult,
  validateManifest,
  validatePluginContents,
} from '../../brain_flowork_utils/plugins/validatePlugin.js'
...
export async function pluginValidateHandler(
  ...
  try {
    ...
    // If this is a plugin manifest located inside a .flowork-plugin directory,
    ...
    if (result.fileType === 'plugin') {
      ...
      if (basename(manifestDir) === '.flowork-plugin') {
