...
import { clearMcpClientConfig, clearServerTokensFromLocalStorage, getMcpClientConfig, readClientSecret, saveMcpClientSecret } from '../../brain_flowork_services/mcp/auth.js';
import { connectToServer, getMcpServerConnectionBatchSize } from '../../brain_flowork_services/mcp/client.js';
import { addMcpConfig, getAllMcpConfigs, getMcpConfigByName, getMcpConfigsByScope, removeMcpConfig } from '../../brain_flowork_services/mcp/config.js';
import type { ConfigScope, ScopedMcpServerConfig } from '../../brain_flowork_services/mcp/types.js';
import { describeMcpConfigFilePath, ensureConfigScope, getScopeLabel } from '../../brain_flowork_services/mcp/utils.js';
import { AppStateProvider } from '../../brain_flowork_state/AppState.js';
import { getCurrentProjectConfig, getGlobalConfig, saveCurrentProjectConfig } from '../../brain_flowork_utils/config.js';
import { isFsInaccessible } from '../../brain_flowork_utils/errors.js';
...
export async function mcpResetChoicesHandler(): Promise<void> {
  ...
  cliOk('All project-scoped (.mcp.json) server approvals and rejections have been reset.\n' + 'You will be prompted for approval next time you start Flowork AI Engine.');
}
