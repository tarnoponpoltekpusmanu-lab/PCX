...
import { getAutoModeConfig } from '../../brain_flowork_utils/settings/settings.js'
...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for Flowork AI Engine.\n' +
  '\n' +
  'Flowork AI Engine has an "auto mode" that uses an AI classifier to decide whether ' +
