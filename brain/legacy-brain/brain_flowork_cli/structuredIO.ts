...
import { SDKControlElicitationResponseSchema } from 'src/brain_flowork_entrypoints/sdk/controlSchemas.js'
import type {
  SDKControlRequest,
  SDKControlResponse,
  StdinMessage,
...
import { type HookCallback, hookJSONOutputSchema } from 'src/brain_flowork_types/hooks.js'
...
import { AbortError } from 'src/brain_flowork_utils/errors.js'
import {
...
} from 'src/brain_flowork_utils/permissions/PermissionResult.js'
import { hasPermissionsToUseTool } from 'src/brain_flowork_utils/permissions/permissions.js'
import { writeToStdout } from 'src/brain_flowork_utils/process.js'
...
import { normalizeControlMessageKeys } from '../brain_flowork_utils/controlMessageCompat.js'
import { executePermissionRequestHooks } from '../brain_flowork_utils/hooks.js'
import {
  applyPermissionUpdates,
  persistPermissionUpdates,
} from '../brain_flowork_utils/permissions/PermissionUpdate.js'
import {
  notifySessionStateChanged,
  type RequiresActionDetails,
  type SessionExternalMetadata,
} from '../brain_flowork_utils/sessionState.js'
  ...
  private async processLine(
    ...
    try {
      ...
      if (message.type === 'update_environment_variables') {
        ...
        // (FLOWORK_ENGINE_SESSION_ACCESS_TOKEN) which must be readable
