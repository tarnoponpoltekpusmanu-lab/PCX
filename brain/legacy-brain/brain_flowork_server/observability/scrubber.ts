...
/** Matches FloworkOS API keys: sk-ant-api03-... or similar variants */
const FLOWORKOS_KEY_RE = /\bsk-ant-[A-Za-z0-9\-_]{8,}\b/g;
...
/** Redact FloworkOS API keys in a string, keeping a short suffix for debugging. */
export function scrubString(value: string): string {
  return value
    .replace(FLOWORKOS_KEY_RE, (match) => `sk-ant-...${match.slice(-4)}****`)
