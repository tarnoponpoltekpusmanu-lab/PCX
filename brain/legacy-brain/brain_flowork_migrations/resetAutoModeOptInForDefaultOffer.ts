...
import { getAutoModeEnabledState } from '../brain_flowork_utils/permissions/permissionSetup.js'
import {
 ...
 * Guard lives in GlobalConfig (~/.flowork.json), not settings.json, so it
