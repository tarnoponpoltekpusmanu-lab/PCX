 ...
 * FloworkEngineInternalEvent.additional_metadata as JSON.
 */
...
/**
 * FloworkEngineInternalEvent represents events logged from Flowork AI Engine via Statsig
 ...
 */
export interface FloworkEngineInternalEvent {
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      remote_environment_type: isSet(object.remote_environment_type)
        ...
        : '',
      claude_code_container_id: isSet(object.flowork_code_container_id)
        ? globalThis.String(object.flowork_code_container_id)
        : '',
      claude_code_remote_session_id: isSet(object.flowork_code_remote_session_id)
        ? globalThis.String(object.flowork_code_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.flowork_code_container_id !== undefined) {
      obj.flowork_code_container_id = message.flowork_code_container_id
    }
    if (message.flowork_code_remote_session_id !== undefined) {
      obj.flowork_code_remote_session_id = message.flowork_code_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.flowork_code_container_id = object.flowork_code_container_id ?? ''
    message.flowork_code_remote_session_id =
      object.flowork_code_remote_session_id ?? ''
...
function createBaseFloworkEngineInternalEvent(): FloworkEngineInternalEvent {
  return {
    event_name: '',
...
export const FloworkEngineInternalEvent: MessageFns<FloworkEngineInternalEvent> = {
  fromJSON(object: any): FloworkEngineInternalEvent {
    return {
  ...
  toJSON(message: FloworkEngineInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<FloworkEngineInternalEvent>, I>>(
    base?: I,
  ): FloworkEngineInternalEvent {
    return FloworkEngineInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<FloworkEngineInternalEvent>, I>>(
    object: I,
  ): FloworkEngineInternalEvent {
    const message = createBaseFloworkEngineInternalEvent()
