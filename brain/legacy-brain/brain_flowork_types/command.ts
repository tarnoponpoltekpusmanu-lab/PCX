import type { ContentBlockParam } from '@floworkos-ai/sdk/resources/index.mjs'
import type { UUID } from 'crypto'
import type { CanUseToolFn } from '../hooks/useCanUseTool.js'
import type { CompactionResult } from '../brain_flowork_services/compact/compact.js'
...
import type { IDEExtensionInstallationStatus, IdeType } from '../brain_flowork_utils/ide.js'
import type { SettingSource } from '../brain_flowork_utils/settings/constants.js'
import type { HooksSettings } from '../brain_flowork_utils/settings/types.js'
 ...
 * claude.ai subscribers and direct Console API key users (api.floworkos.com),
...
export type CommandAvailability =
  ...
  | 'claude-ai'
  // Console API key user (direct api.floworkos.com, not via claude.ai OAuth)
  | 'console'
