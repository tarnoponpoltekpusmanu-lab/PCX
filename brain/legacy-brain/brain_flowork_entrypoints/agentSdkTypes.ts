/**
 * Main entrypoint for Flowork AI Engine Agent SDK types.
 *
 ...
 *
 * If your SDK MCP calls will run longer than 60s, override FLOWORK_ENGINE_STREAM_CLOSE_TIMEOUT
 */
...
/**
 * A scheduled task from `<dir>/.flowork/scheduled_tasks.json`.
 * @internal
 */
...
/**
 * Watch `<dir>/.flowork/scheduled_tasks.json` and yield events as tasks fire.
 *
