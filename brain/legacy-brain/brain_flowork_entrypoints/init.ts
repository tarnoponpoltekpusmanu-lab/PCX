...
import { getIsNonInteractiveSession } from 'src/brain_flowork_bootstrap/state.js'
import type { AttributedCounter } from '../brain_flowork_bootstrap/state.js'
import { getSessionCounter, setMeter } from '../brain_flowork_bootstrap/state.js'
import { shutdownLspServerManager } from '../brain_flowork_services/lsp/manager.js'
import { populateOAuthAccountInfoIfNeeded } from '../brain_flowork_services/oauth/client.js'
import {
  initializePolicyLimitsLoadingPromise,
  isPolicyLimitsEligible,
} from '../brain_flowork_services/policyLimits/index.js'
import {
  initializeRemoteManagedSettingsLoadingPromise,
  isEligibleForRemoteManagedSettings,
  waitForRemoteManagedSettingsToLoad,
} from '../brain_flowork_services/remoteManagedSettings/index.js'
import { preconnectFloworkOSApi } from '../brain_flowork_utils/apiPreconnect.js'
import { applyExtraCACertsFromConfig } from '../brain_flowork_utils/caCertsConfig.js'
import { registerCleanup } from '../brain_flowork_utils/cleanupRegistry.js'
import { enableConfigs, recordFirstStartTime } from '../brain_flowork_utils/config.js'
import { logForDebugging } from '../brain_flowork_utils/debug.js'
import { detectCurrentRepository } from '../brain_flowork_utils/detectRepository.js'
import { logForDiagnosticsNoPII } from '../brain_flowork_utils/diagLogs.js'
import { initJetBrainsDetection } from '../brain_flowork_utils/envDynamic.js'
import { isEnvTruthy } from '../brain_flowork_utils/envUtils.js'
import { ConfigParseError, errorMessage } from '../brain_flowork_utils/errors.js'
// showInvalidConfigDialog is dynamically imported in the error path to avoid loading React at init
import {
  gracefulShutdownSync,
  setupGracefulShutdown,
} from '../brain_flowork_utils/gracefulShutdown.js'
import {
  applyConfigEnvironmentVariables,
  applySafeConfigEnvironmentVariables,
} from '../brain_flowork_utils/managedEnv.js'
import { configureGlobalMTLS } from '../brain_flowork_utils/mtls.js'
import {
  ensureScratchpadDir,
  isScratchpadEnabled,
...
import { configureGlobalAgents } from '../brain_flowork_utils/proxy.js'
import { isBetaTracingEnabled } from '../brain_flowork_utils/telemetry/betaSessionTracing.js'
import { getTelemetryAttributes } from '../brain_flowork_utils/telemetryAttributes.js'
import { setShellIfWindows } from '../brain_flowork_utils/windowsPaths.js'
...
export const init = memoize(async (): Promise<void> => {
  ...
  try {
    ...
    // Preconnect to the FloworkOS API — overlap TCP+TLS handshake
    ...
    // FLOWORK_ENGINE_REMOTE + GrowthBook; fail-open on any error. Lazy import so
