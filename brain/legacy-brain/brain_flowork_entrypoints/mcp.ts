...
import { getDefaultAppState } from 'src/brain_flowork_state/AppStateStore.js'
import review from '../brain_flowork_commands_dir/review.js'
...
import { getTools } from '../brain_flowork_tools.js'
import { createAbortController } from '../brain_flowork_utils/abortController.js'
import { createFileStateCacheWithSizeLimit } from '../brain_flowork_utils/fileStateCache.js'
import { logError } from '../brain_flowork_utils/log.js'
import { createAssistantMessage } from '../brain_flowork_utils/messages.js'
import { getMainLoopModel } from '../brain_flowork_utils/model/model.js'
import { hasPermissionsToUseTool } from '../brain_flowork_utils/permissions/permissions.js'
import { setCwd } from '../brain_flowork_utils/Shell.js'
import { jsonStringify } from '../brain_flowork_utils/slowOperations.js'
import { getErrorParts } from '../brain_flowork_utils/toolErrors.js'
import { zodToJsonSchema } from '../brain_flowork_utils/zodToJsonSchema.js'
        ...
        tools: await Promise.all(
          tools.map(async tool => {
            ...
            if (tool.outputSchema) {
              ...
              // See: https://github.com/floworkoss/flowork-engine/issues/8014
              if (
