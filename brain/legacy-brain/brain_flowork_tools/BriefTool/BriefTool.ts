...
import { getKairosActive, getUserMsgOptIn } from '../../brain_flowork_bootstrap/state.js'
 ...
 *
 * FLOWORK_ENGINE_BRIEF env var force-grants entitlement for dev/testing —
...
export function isBriefEntitled(): boolean {
  ...
  return feature('KAIROS') || feature('KAIROS_BRIEF')
    ? getKairosActive() ||
        isEnvTruthy(process.env.FLOWORK_ENGINE_BRIEF) ||
 ...
 *   - FLOWORK_ENGINE_BRIEF env var (maybeActivateBrief — dev/testing bypass)
