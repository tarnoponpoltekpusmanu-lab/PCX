...
import { countLinesChanged, getPatchForDisplay } from '../../brain_flowork_utils/diff.js'
import { isEnvTruthy } from '../../brain_flowork_utils/envUtils.js'
import { isENOENT } from '../../brain_flowork_utils/errors.js'
import { getFileModificationTime, writeTextContent } from '../../brain_flowork_utils/file.js'
import {
  fileHistoryEnabled,
  fileHistoryTrackEdit,
} from '../../brain_flowork_utils/fileHistory.js'
import { logFileOperation } from '../../brain_flowork_utils/fileOperationAnalytics.js'
import { readFileSyncWithMetadata } from '../../brain_flowork_utils/fileRead.js'
...
export const FileWriteTool = buildTool({
  ...
  async call(
    ...
    // Log when writing to FLOWORK.md
    if (fullFilePath.endsWith(`${sep}FLOWORK.md`)) {
