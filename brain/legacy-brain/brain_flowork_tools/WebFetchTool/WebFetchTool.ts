...
import type { PermissionUpdate } from '../../brain_flowork_types/permissions.js'
...
import { getRuleByContentsForTool } from '../../brain_flowork_utils/permissions/permissions.js'
...
export const WebFetchTool = buildTool({
  ...
  async prompt(_options) {
    ...
    // MCP tool count thresholds), invalidating the FloworkOS API prompt
