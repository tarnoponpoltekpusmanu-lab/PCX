...
import type { ToolResultBlockParam } from '@floworkos-ai/sdk/resources/index.mjs';
import { copyFile, stat as fsStat, truncate as fsTruncate, link } from 'fs/promises';
import * as React from 'react';
import type { CanUseToolFn } from 'src/hooks/useCanUseTool.js';
import type { AppState } from 'src/brain_flowork_state/AppState.js';
import { z } from 'zod/v4';
import { getKairosActive } from '../../brain_flowork_bootstrap/state.js';
import { TOOL_SUMMARY_MAX_LENGTH } from '../../brain_flowork_constants/toolLimits.js';
import { type AnalyticsMetadata_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS, logEvent } from '../../brain_flowork_services/analytics/index.js';
import { notifyVscodeFileUpdated } from '../../brain_flowork_services/mcp/vscodeSdkMcp.js';
import type { SetToolJSXFn, ToolCallProgress, ToolUseContext, ValidationResult } from '../../brain_flowork_tool.js';
import { buildTool, type ToolDef } from '../../brain_flowork_tool.js';
import { backgroundExistingForegroundTask, markTaskNotified, registerForeground, spawnShellTask, unregisterForeground } from '../../brain_flowork_tasks_dir/LocalShellTask/LocalShellTask.js';
import type { AgentId } from '../../brain_flowork_types/ids.js';
import type { AssistantMessage } from '../../brain_flowork_types/message.js';
import { parseForSecurity } from '../../brain_flowork_utils/bash/ast.js';
import { splitCommand_DEPRECATED, splitCommandWithOperators } from '../../brain_flowork_utils/bash/commands.js';
import { extractFloworkEngineHints } from '../../brain_flowork_utils/floworkEngineHints.js';
import { detectCodeIndexingFromCommand } from '../../brain_flowork_utils/codeIndexing.js';
import { isEnvTruthy } from '../../brain_flowork_utils/envUtils.js';
import { isENOENT, ShellError } from '../../brain_flowork_utils/errors.js';
import { detectFileEncoding, detectLineEndings, getFileModificationTime, writeTextContent } from '../../brain_flowork_utils/file.js';
import { fileHistoryEnabled, fileHistoryTrackEdit } from '../../brain_flowork_utils/fileHistory.js';
import { truncate } from '../../brain_flowork_utils/format.js';
import { getFsImplementation } from '../../brain_flowork_utils/fsOperations.js';
import { lazySchema } from '../../brain_flowork_utils/lazySchema.js';
import { expandPath } from '../../brain_flowork_utils/path.js';
import type { PermissionResult } from '../../brain_flowork_utils/permissions/PermissionResult.js';
import { maybeRecordPluginHint } from '../../brain_flowork_utils/plugins/hintRecommendation.js';
import { exec } from '../../brain_flowork_utils/Shell.js';
import type { ExecResult } from '../../brain_flowork_utils/ShellCommand.js';
import { SandboxManager } from '../../brain_flowork_utils/sandbox/sandbox-adapter.js';
import { semanticBoolean } from '../../brain_flowork_utils/semanticBoolean.js';
import { semanticNumber } from '../../brain_flowork_utils/semanticNumber.js';
import { EndTruncatingAccumulator } from '../../brain_flowork_utils/stringUtils.js';
import { getTaskOutputPath } from '../../brain_flowork_utils/task/diskOutput.js';
import { TaskOutput } from '../../brain_flowork_utils/task/TaskOutput.js';
import { isOutputLineTruncated } from '../../brain_flowork_utils/terminal.js';
import { buildLargeToolResultMessage, ensureToolResultsDir, generatePreview, getToolResultPath, PREVIEW_SIZE_BYTES } from '../../brain_flowork_utils/toolResultStorage.js';
...
isEnvTruthy(process.env.FLOWORK_ENGINE_DISABLE_BACKGROUND_TASKS);
...
export type { BashProgress } from '../../brain_flowork_types/tools.js';
import type { BashProgress } from '../../brain_flowork_types/tools.js';
...
export const BashTool = buildTool({
  ...
  userFacingName(input) {
    ...
    return isEnvTruthy(process.env.FLOWORK_ENGINE_BASH_SANDBOX_SHOW_INDICATOR) && shouldUseSandbox(input) ? 'SandboxedBash' : 'Bash';
  },
  ...
  mapToolResultToToolResultBlockParam({
    ...
    // For image data, format as image content block for Flowork
    if (isImage) {
  ...
  async call(input: BashToolInput, toolUseContext, _canUseTool?: CanUseToolFn, parentMessage?: AssistantMessage, onProgress?: ToolCallProgress<BashProgress>) {
    ...
    // Flowork AI Engine hints protocol: CLIs/SDKs gated on CLAUDECODE=1 emit a
    // `<flowork-engine-hint />` tag to stderr (merged into stdout here). Scan,
    // record for useFloworkEngineHintRecommendation to surface, then strip
    // so the model never sees the tag — a zero-token side channel.
    // Stripping runs unconditionally (subagent output must stay clean too);
    // only the dialog recording is main-thread-only.
    const extracted = extractFloworkEngineHints(strippedStdout, input.command);
