...
import type { SetToolJSXFn, Tool, ToolCallProgress, ValidationResult } from '../../brain_flowork_tool.js';
...
import { errorMessage as getErrorMessage, ShellError } from '../../brain_flowork_utils/errors.js';
...
import { getPlatform } from '../../brain_flowork_utils/platform.js';
...
import { getCachedPowerShellPath } from '../../brain_flowork_utils/shell/powershellDetection.js';
...
import type { PowerShellProgress } from '../../brain_flowork_types/tools.js';
export type { PowerShellProgress } from '../../brain_flowork_types/tools.js';
  ...
  async call(input: PowerShellToolInput, toolUseContext: Parameters<Tool['call']>[1], _canUseTool?: CanUseToolFn, _parentMessage?: AssistantMessage, onProgress?: ToolCallProgress<PowerShellProgress>): Promise<{
    ...
    try {
      ...
      if (result.backgroundTaskId) {
        const bgExtracted = extractFloworkEngineHints(result.stdout || '', input.command);
      ...
      const extracted = extractFloworkEngineHints(stdout, input.command);
