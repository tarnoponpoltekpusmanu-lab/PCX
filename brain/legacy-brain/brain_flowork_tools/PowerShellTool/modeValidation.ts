...
import type { ParsedPowerShellCommand } from '../../brain_flowork_utils/powershell/parser.js'
import {
  deriveSecurityFlags,
  getPipelineSegments,
...
export function checkPermissionMode(
  ...
  // Example: `Set-Location ./.flowork; Set-Content ./settings.json '...'` — the validator
  // sees ./settings.json as /project/settings.json, but PowerShell writes to
  // /project/.flowork/settings.json. Refuse to auto-allow any write operation in a
