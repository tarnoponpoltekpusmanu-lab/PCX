import type { Base64ImageSource } from '@floworkos-ai/sdk/resources/index.mjs'
...
import { hasBinaryExtension } from '../../brain_flowork_constants/files.js'
import { memoryFreshnessNote } from '../../brain_flowork_memdir/memoryAge.js'
...
} from '../../brain_flowork_services/analytics/metadata.js'
import {
  countTokensWithAPI,
  roughTokenCountEstimationForFileType,
} from '../../brain_flowork_services/tokenEstimation.js'
import {
...
import { getClaudeConfigHomeDir, isEnvTruthy } from '../../brain_flowork_utils/envUtils.js'
import { getErrnoCode, isENOENT } from '../../brain_flowork_utils/errors.js'
import {
  addLineNumbers,
  ...
  suggestPathUnderCwd,
} from '../../brain_flowork_utils/file.js'
import { logFileOperation } from '../../brain_flowork_utils/fileOperationAnalytics.js'
...
} from '../../brain_flowork_utils/imageResizer.js'
import { lazySchema } from '../../brain_flowork_utils/lazySchema.js'
import { logError } from '../../brain_flowork_utils/log.js'
import { isAutoMemFile } from '../../brain_flowork_utils/memoryFileDetection.js'
import { createUserMessage } from '../../brain_flowork_utils/messages.js'
import { getCanonicalName, getMainLoopModel } from '../../brain_flowork_utils/model/model.js'
import {
  mapNotebookCellsToToolResult,
  readNotebook,
} from '../../brain_flowork_utils/notebook.js'
import { expandPath } from '../../brain_flowork_utils/path.js'
import { extractPDFPages, getPDFPageCount, readPDF } from '../../brain_flowork_utils/pdf.js'
import {
  isPDFExtension,
  isPDFSupported,
  parsePDFPageRange,
} from '../../brain_flowork_utils/pdfUtils.js'
import {
  checkReadPermissionForTool,
  matchingRuleForInput,
} from '../../brain_flowork_utils/permissions/filesystem.js'
import type { PermissionDecision } from '../../brain_flowork_utils/permissions/PermissionResult.js'
import { matchWildcardPattern } from '../../brain_flowork_utils/permissions/shellRuleMatching.js'
import { readFileInRange } from '../../brain_flowork_utils/readFileInRange.js'
 ...
 * Only matches files within the Claude config directory (e.g., ~/.flowork).
...
function detectSessionFileType(
  ...
  // Session memory files: ~/.flowork/session-memory/*.md (including summary.md)
  if (
  ...
  // Session JSONL transcript files: ~/.flowork/projects/*/*.jsonl
  if (
