import { isPDFSupported } from '../../brain_flowork_utils/pdfUtils.js'
...
${offsetInstruction}
${lineFormat}
- This tool allows Flowork AI Engine to read images (eg PNG, JPG, etc). When reading an image file the contents are presented visually as Flowork AI Engine is a multimodal LLM.${
    isPDFSupported()
