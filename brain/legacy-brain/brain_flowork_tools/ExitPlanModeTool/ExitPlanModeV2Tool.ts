...
import { formatAgentId, generateRequestId } from '../../brain_flowork_utils/agentId.js'
...
} from '../../brain_flowork_utils/inProcessTeammateHelpers.js'
...
} from '../../brain_flowork_utils/plans.js'
...
const permissionSetupModule = feature('TRANSCRIPT_CLASSIFIER')
  ? (require('../../brain_flowork_utils/permissions/permissionSetup.js') as typeof import('../../utils/permissions/permissionSetup.js'))
  : null
/* eslint-enable @typescript-eslint/no-require-imports */

/**
 * Schema for prompt-based permission requests.
 * Used by Flowork AI to request semantic permissions when exiting plan mode.
 */
