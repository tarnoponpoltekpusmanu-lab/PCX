...
import { clearDeliveredDiagnosticsForFile } from '../../brain_flowork_services/lsp/LSPDiagnosticRegistry.js'
import { getLspServerManager } from '../../brain_flowork_services/lsp/manager.js'
import { notifyVscodeFileUpdated } from '../../brain_flowork_services/mcp/vscodeSdkMcp.js'
import { checkTeamMemSecrets } from '../../brain_flowork_services/teamMemorySync/teamMemSecretGuard.js'
import {
...
import { countLinesChanged } from '../../brain_flowork_utils/diff.js'
import { isEnvTruthy } from '../../brain_flowork_utils/envUtils.js'
import { isENOENT } from '../../brain_flowork_utils/errors.js'
import {
...
} from '../../brain_flowork_utils/fileRead.js'
...
import {
  ...
  type ToolUseDiff,
} from '../../brain_flowork_utils/gitDiff.js'
...
import { validateInputForSettingsFileEdit } from '../../brain_flowork_utils/settings/validateEditTool.js'
...
export const FileEditTool = buildTool({
  ...
  async validateInput(input: FileEditInput, toolUseContext: ToolUseContext) {
    ...
    // Additional validation for Flowork settings files
  ...
  async call(
    ...
    // 7. Log events
    if (absoluteFilePath.endsWith(`${sep}FLOWORK.md`)) {
