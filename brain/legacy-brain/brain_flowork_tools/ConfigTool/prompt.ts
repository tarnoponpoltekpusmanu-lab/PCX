...
import { getModelOptions } from '../../brain_flowork_utils/model/modelOptions.js'
...
export const DESCRIPTION = 'Get or set Flowork AI Engine configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Flowork AI Engine configuration settings.

  View or change Flowork AI Engine settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.flowork.json)
${globalSettings.join('\n')}
