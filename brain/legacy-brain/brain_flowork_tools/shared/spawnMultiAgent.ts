...
import type { InProcessTeammateTaskState } from '../../brain_flowork_tasks_dir/InProcessTeammateTask/types.js'
import { formatAgentId } from '../../brain_flowork_utils/agentId.js'
import { quote } from '../../brain_flowork_utils/bash/shellQuote.js'
import { isInBundledMode } from '../../brain_flowork_utils/bundledMode.js'
...
import { parseUserSpecifiedModel } from '../../brain_flowork_utils/model/model.js'
import type { PermissionMode } from '../../brain_flowork_utils/permissions/PermissionMode.js'
import { isTmuxAvailable } from '../../brain_flowork_utils/swarm/backends/detection.js'
import {
  detectAndGetBackend,
  getBackendByType,
  isInProcessEnabled,
...
} from '../../brain_flowork_utils/swarm/backends/registry.js'
import { getTeammateModeFromSnapshot } from '../../brain_flowork_utils/swarm/backends/teammateModeSnapshot.js'
import type { BackendType } from '../../brain_flowork_utils/swarm/backends/types.js'
import { isPaneBackend } from '../../brain_flowork_utils/swarm/backends/types.js'
import {
  SWARM_SESSION_NAME,
  TEAM_LEAD_NAME,
  TEAMMATE_COMMAND_ENV_VAR,
  TMUX_COMMAND,
} from '../../brain_flowork_utils/swarm/constants.js'
import { It2SetupPrompt } from '../../brain_flowork_utils/swarm/It2SetupPrompt.js'
import { startInProcessTeammate } from '../../brain_flowork_utils/swarm/inProcessRunner.js'
import {
  type InProcessSpawnConfig,
  spawnInProcessTeammate,
} from '../../brain_flowork_utils/swarm/spawnInProcess.js'
import { buildInheritedEnvVars } from '../../brain_flowork_utils/swarm/spawnUtils.js'
import {
  readTeamFileAsync,
  sanitizeAgentName,
  sanitizeName,
  writeTeamFileAsync,
} from '../../brain_flowork_utils/swarm/teamHelpers.js'
import {
  assignTeammateColor,
  ...
  isInsideTmux,
  sendCommandToPane,
} from '../../brain_flowork_utils/swarm/teammateLayoutManager.js'
import { getHardcodedTeammateModelFallback } from '../../brain_flowork_utils/swarm/teammateModel.js'
import { registerTask } from '../../brain_flowork_utils/task/framework.js'
import { writeToMailbox } from '../../brain_flowork_utils/teammateMailbox.js'
...
async function handleSpawnSplitPane(
  ...
  // Build the command to spawn Flowork AI Engine with teammate identity
  // Note: We spawn without a prompt - initial instructions are sent via mailbox
  const binaryPath = getTeammateCommand()

  // Build teammate identity CLI args (replaces FLOWORK_ENGINE_* env vars)
  const teammateArgs = [
  ...
  // Includes CLAUDECODE, FLOWORK_ENGINE_EXPERIMENTAL_AGENT_TEAMS, and API provider vars.
...
/**
 * Handle spawn operation - creates a new Flowork AI Engine instance.
