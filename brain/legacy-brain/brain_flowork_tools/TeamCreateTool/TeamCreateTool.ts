...
import { getResolvedTeammateMode } from '../../brain_flowork_utils/swarm/backends/registry.js'
import { TEAM_LEAD_NAME } from '../../brain_flowork_utils/swarm/constants.js'
import type { TeamFile } from '../../brain_flowork_utils/swarm/teamHelpers.js'
import {
  getTeamFilePath,
  readTeamFile,
...
import { assignTeammateColor } from '../../brain_flowork_utils/swarm/teammateLayoutManager.js'
import {
  ensureTasksDir,
  resetTaskList,
  setLeaderTeamName,
} from '../../brain_flowork_utils/tasks.js'
import { generateWordSlug } from '../../brain_flowork_utils/words.js'
...
export const TeamCreateTool: Tool<InputSchema, Output> = buildTool({
  ...
  async call(input, context) {
    ...
    // Note: We intentionally don't set FLOWORK_ENGINE_AGENT_ID for the team lead because:
