...
} from './brain_flowork_tools/AgentTool/loadAgentsDir.js'
import type {
  AssistantMessage,
  AttachmentMessage,
  Message,
...
import type {
  ...
  ToolProgressData,
  WebSearchProgress,
} from './brain_flowork_types/tools.js'
import type { FileStateCache } from './brain_flowork_utils/fileStateCache.js'
import type { DenialTrackingState } from './brain_flowork_utils/permissions/denialTracking.js'
import type { SystemPrompt } from './brain_flowork_utils/systemPromptType.js'
...
import type { SDKStatus } from './brain_flowork_entrypoints/agentSdkTypes.js'
...
import type { Theme, ThemeName } from './brain_flowork_utils/theme.js'
...
import type { ToolPermissionRulesBySource } from './brain_flowork_types/permissions.js'
...
export type ToolUseContext = {
  ...
  /**
   * FLOWORK.md paths already injected as nested_memory attachments this
   ...
   * re-inject the same FLOWORK.md dozens of times.
   */
...
> = {
   ...
   * `_meta['floworkos/alwaysLoad']`. Use for tools the model must see on
