...
import { accumulateUsage, updateUsage } from 'src/brain_flowork_services/api/claude.js'
import type { NonNullableUsage } from 'src/brain_flowork_services/api/logging.js'
...
import { getSlashCommandToolSkills } from './brain_flowork_commands.js'
import {
...
import {
  ...
  getTotalAPIDuration,
  getTotalCost,
} from './brain_flowork_cost_tracker.js'
import type { CanUseToolFn } from './hooks/useCanUseTool.js'
import { loadMemoryPrompt } from './brain_flowork_memdir/memdir.js'
import { hasAutoMemPathOverride } from './brain_flowork_memdir/paths.js'
import { query } from './brain_flowork_query.js'
import { categorizeRetryableAPIError } from './brain_flowork_services/api/errors.js'
import type { MCPServerConnection } from './brain_flowork_services/mcp/types.js'
import type { AppState } from './brain_flowork_state/AppState.js'
import { type Tools, type ToolUseContext, toolMatchesName } from './brain_flowork_tool.js'
...
import type { Message } from './brain_flowork_types/message.js'
import type { OrphanedPermission } from './brain_flowork_types/textInputTypes.js'
import { createAbortController } from './brain_flowork_utils/abortController.js'
import type { AttributionState } from './brain_flowork_utils/commitAttribution.js'
import { getGlobalConfig } from './brain_flowork_utils/config.js'
import { getCwd } from './brain_flowork_utils/cwd.js'
import { isBareMode, isEnvTruthy } from './brain_flowork_utils/envUtils.js'
import { getFastModeState } from './brain_flowork_utils/fastMode.js'
import {
  type FileHistoryState,
  fileHistoryEnabled,
  fileHistoryMakeSnapshot,
} from './brain_flowork_utils/fileHistory.js'
import {
  cloneFileStateCache,
  type FileStateCache,
} from './brain_flowork_utils/fileStateCache.js'
import { headlessProfilerCheckpoint } from './brain_flowork_utils/headlessProfiler.js'
import { registerStructuredOutputEnforcement } from './brain_flowork_utils/hooks/hookHelpers.js'
import { getInMemoryErrors } from './brain_flowork_utils/log.js'
import { countToolCalls, SYNTHETIC_MESSAGES } from './brain_flowork_utils/messages.js'
import {
  getMainLoopModel,
...
import {
  ...
  processUserInput,
} from './brain_flowork_utils/processUserInput/processUserInput.js'
import { fetchSystemPromptParts } from './brain_flowork_utils/queryContext.js'
import { setCwd } from './brain_flowork_utils/Shell.js'
import {
  flushSessionStorage,
  recordTranscript,
} from './brain_flowork_utils/sessionStorage.js'
import { asSystemPrompt } from './brain_flowork_utils/systemPromptType.js'
import { resolveThemeSetting } from './brain_flowork_utils/systemTheme.js'
import {
  shouldEnableThinkingByDefault,
  type ThinkingConfig,
} from './brain_flowork_utils/thinking.js'

// Lazy: MessageSelector.tsx pulls React/ink; only needed for message filtering at query time
/* eslint-disable @typescript-eslint/no-require-imports */
const messageSelector =
  (): typeof import('src/components/MessageSelector.js') =>
    require('src/brain_flowork_components/MessageSelector.js')

import {
  localCommandOutputToSDKAssistantMessage,
  toSDKCompactMetadata,
} from './brain_flowork_utils/messages/mappers.js'
import {
  buildSystemInitMessage,
  sdkCompatToolName,
} from './brain_flowork_utils/messages/systemInit.js'
import {
  getScratchpadDir,
  isScratchpadEnabled,
...
import {
  ...
  isResultSuccessful,
  normalizeMessage,
} from './brain_flowork_utils/queryHelpers.js'
...
const getCoordinatorUserContext: (
  ...
  ? require('./brain_flowork_coordinator/coordinatorMode.js').getCoordinatorUserContext
  : () => ({})
/* eslint-enable @typescript-eslint/no-require-imports */
  ...
  async *submitMessage(
    ...
    if (persistSession && messagesFromUserInput.length > 0) {
      ...
      if (isBareMode()) {
        ...
        if (
          isEnvTruthy(process.env.FLOWORK_ENGINE_EAGER_FLUSH) ||
          isEnvTruthy(process.env.FLOWORK_ENGINE_IS_COWORK)
        ) {
    ...
    // ref-tracked plugins. CCR populates the cache via FLOWORK_ENGINE_SYNC_PLUGIN_INSTALL
    // (headlessPluginInstall) or FLOWORK_ENGINE_PLUGIN_SEED_DIR before this runs;
