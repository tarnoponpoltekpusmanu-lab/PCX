...
import { getWorktreePathsPortable } from '../brain_flowork_utils/getWorktreePathsPortable.js'
import { lazySchema } from '../brain_flowork_utils/lazySchema.js'
import {
  getProjectsDir,
  sanitizePath,
} from '../brain_flowork_utils/sessionStoragePortable.js'
 ...
 * and handles errors — no existence check (FLOWORK.md TOCTOU rule). Returns
