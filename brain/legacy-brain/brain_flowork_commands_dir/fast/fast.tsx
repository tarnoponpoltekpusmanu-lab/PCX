...
import { type AppState, useAppState, useSetAppState } from '../../brain_flowork_state/AppState.js';
import type { LocalJSXCommandOnDone } from '../../brain_flowork_types/command.js';
import { clearFastModeCooldown, FAST_MODE_MODEL_DISPLAY, getFastModeModel, getFastModeRuntimeState, getFastModeUnavailableReason, isFastModeEnabled, isFastModeSupportedByModel, prefetchFastModeStatus } from '../../brain_flowork_utils/fastMode.js';
import { formatDuration } from '../../brain_flowork_utils/format.js';
import { formatModelPricing, getOpus46CostTier } from '../../brain_flowork_utils/modelCost.js';
...
export function FastModePicker(t0) {
  ...
  if ($[25] === Symbol.for("react.memo_cache_sentinel")) {
    t11 = <Text dimColor={true}>Learn more:{" "}<Link url="https://code.flowork.com/docs/en/fast-mode">https://code.flowork.com/docs/en/fast-mode</Link></Text>;
    $[25] = t11;
  } else {
    t11 = $[25];
  }
