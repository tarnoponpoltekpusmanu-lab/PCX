...
import { clearMemoryFileCaches, getMemoryFiles } from '../../brain_flowork_utils/claudemd.js';
...
import { editFileInEditor } from '../../brain_flowork_utils/promptEditor.js';
function MemoryCommand({
  ...
  return <Dialog title="Memory" onCancel={handleCancel} color="remember">
      <Box flexDirection="column">
        ...
        <Box marginTop={1}>
          <Text dimColor>
            Learn more: <Link url="https://code.flowork.com/docs/en/memory" />
          </Text>
        </Box>
      </Box>
    </Dialog>;
