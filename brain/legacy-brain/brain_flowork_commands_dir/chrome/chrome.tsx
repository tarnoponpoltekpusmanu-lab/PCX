...
import { CLAUDE_IN_CHROME_MCP_SERVER_NAME, openInChrome } from '../../brain_flowork_utils/claudeInChrome/common.js';
import { isChromeExtensionInstalled } from '../../brain_flowork_utils/claudeInChrome/setup.js';
...
function ClaudeInChromeMenu(t0) {
  ...
  if ($[20] === Symbol.for("react.memo_cache_sentinel")) {
    t6 = <Text>Claude in Chrome works with the Chrome extension to let you control your browser directly from Flowork AI Engine. Navigate websites, fill forms, capture screenshots, record GIFs, and debug with console logs and network requests.</Text>;
    $[20] = t6;
  } else {
    t6 = $[20];
  }
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    t10 = <Text dimColor={true}>Learn more: https://code.flowork.com/docs/en/chrome</Text>;
    $[33] = t10;
  } else {
    t10 = $[33];
  }
...
export const call = async function (onDone: (result?: string) => void): Promise<React.ReactNode> {
  ...
  return <ClaudeInChromeMenu onDone={onDone} isExtensionInstalled={isExtensionInstalled} configEnabled={config.floworkInChromeDefaultEnabled} isClaudeAISubscriber={isSubscriber} isWSL={isWSL} />;
};
