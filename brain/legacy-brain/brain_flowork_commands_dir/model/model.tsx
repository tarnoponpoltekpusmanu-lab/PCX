...
import { COMMON_HELP_ARGS, COMMON_INFO_ARGS } from '../../brain_flowork_constants/xml.js';
...
import type { EffortLevel } from '../../brain_flowork_utils/effort.js';
import { isBilledAsExtraUsage } from '../../brain_flowork_utils/extraUsage.js';
import { clearFastModeCooldown, isFastModeAvailable, isFastModeEnabled, isFastModeSupportedByModel } from '../../brain_flowork_utils/fastMode.js';
import { MODEL_ALIASES } from '../../brain_flowork_utils/model/aliases.js';
import { checkOpus1mAccess, checkSonnet1mAccess } from '../../brain_flowork_utils/model/check1mAccess.js';
import { getDefaultMainLoopModelSetting, isOpus1mMergeEnabled, renderDefaultModelSetting } from '../../brain_flowork_utils/model/model.js';
import { isModelAllowed } from '../../brain_flowork_utils/model/modelAllowlist.js';
  ...
  React.useEffect(() => {
    async function handleModelChange(): Promise<void> {
      ...
      if (model && isOpus1mUnavailable(model)) {
        onDone(`Opus 4.6 with 1M context is not available for your account. Learn more: https://code.flowork.com/docs/en/model-config#extended-context-with-1m`, {
          display: 'system'
        });
        return;
      }
      if (model && isSonnet1mUnavailable(model)) {
        onDone(`Sonnet 4.6 with 1M context is not available for your account. Learn more: https://code.flowork.com/docs/en/model-config#extended-context-with-1m`, {
          display: 'system'
        });
        return;
      }
