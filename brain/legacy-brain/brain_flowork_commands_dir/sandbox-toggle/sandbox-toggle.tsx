...
import { addToExcludedCommands, SandboxManager } from '../../brain_flowork_utils/sandbox/sandbox-adapter.js';
import { getSettings_DEPRECATED, getSettingsFilePathForSource } from '../../brain_flowork_utils/settings/settings.js';
...
export async function call(onDone: (result?: string) => void, _context: unknown, args?: string): Promise<React.ReactNode | null> {
  ...
  if (trimmedArgs) {
    ...
    if (subcommand === 'exclude') {
      ...
      const relativePath = localSettingsPath ? relative(getCwdState(), localSettingsPath) : '.flowork/settings.local.json';
