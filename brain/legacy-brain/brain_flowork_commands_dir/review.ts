...
// user triggers, so the description carries "Flowork AI Engine on the web" + URL.
const CCR_TERMS_URL = 'https://code.flowork.com/docs/en/flowork-engine-on-the-web'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Flowork AI Engine on the web. See ${CCR_TERMS_URL}`,
