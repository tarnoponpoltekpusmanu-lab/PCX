...
import { getOAuthHeaders, prepareApiRequest } from '../../brain_flowork_utils/teleport/api.js'
import { fetchEnvironments } from '../../brain_flowork_utils/teleport/environments.js'
...
> {
  ...
  const headers = {
    ...
    'floworkos-beta': CCR_BYOC_BETA_HEADER,
