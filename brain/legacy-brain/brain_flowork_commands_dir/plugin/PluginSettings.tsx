...
import { loadMarketplacesWithGracefulDegradation } from '../../brain_flowork_utils/plugins/marketplaceHelpers.js';
import { loadKnownMarketplacesConfig, removeMarketplaceSource } from '../../brain_flowork_utils/plugins/marketplaceManager.js';
import { getPluginEditableScopes } from '../../brain_flowork_utils/plugins/pluginStartupCheck.js';
import type { EditableSettingSource } from '../../brain_flowork_utils/settings/constants.js';
...
function ErrorsTabContent(t0) {
  ...
  let t13;
  if ($[13] !== actionMessage) {
    t13 = actionMessage && <Box marginTop={1} marginLeft={1}><Text color="flowork">{actionMessage}</Text></Box>;
    $[13] = actionMessage;
    $[14] = t13;
  } else {
    t13 = $[14];
