...
import { formatInstallCount, getInstallCounts } from '../../brain_flowork_utils/plugins/installCounts.js';
import { isPluginGloballyInstalled } from '../../brain_flowork_utils/plugins/installedPluginsManager.js';
import { createPluginId, detectEmptyMarketplaceReason, type EmptyMarketplaceReason, formatFailureDetails, formatMarketplaceLoadingErrors, loadMarketplacesWithGracefulDegradation } from '../../brain_flowork_utils/plugins/marketplaceHelpers.js';
import { loadKnownMarketplacesConfig } from '../../brain_flowork_utils/plugins/marketplaceManager.js';
import { OFFICIAL_MARKETPLACE_NAME } from '../../brain_flowork_utils/plugins/officialMarketplace.js';
import { installPluginFromMarketplace } from '../../brain_flowork_utils/plugins/pluginInstallationHelpers.js';
...
import { truncateToWidth } from '../../brain_flowork_utils/truncate.js';
    ...
    case "git-not-installed":
      {
        ...
        if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
          t1 = <><Text dimColor={true}>Git is required to install marketplaces.</Text><Text dimColor={true}>Please install git and restart Flowork AI Engine.</Text></>;
          $[0] = t1;
        } else {
          t1 = $[0];
        }
