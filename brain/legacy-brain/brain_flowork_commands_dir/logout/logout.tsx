...
import { clearTrustedDeviceTokenCache } from '../../brain_flowork_bridge/trustedDevice.js';
import { Text } from '../../ink.js';
import { refreshGrowthBookAfterAuthChange } from '../../brain_flowork_services/analytics/growthbook.js';
import { getGroveNoticeConfig, getGroveSettings } from '../../brain_flowork_services/api/grove.js';
import { clearPolicyLimitsCache } from '../../brain_flowork_services/policyLimits/index.js';
// flushTelemetry is loaded lazily to avoid pulling in ~1.1MB of OpenTelemetry at startup
import { clearRemoteManagedSettingsCache } from '../../brain_flowork_services/remoteManagedSettings/index.js';
import { getClaudeAIOAuthTokens, removeApiKey } from '../../brain_flowork_utils/auth.js';
import { clearBetasCaches } from '../../brain_flowork_utils/betas.js';
import { saveGlobalConfig } from '../../brain_flowork_utils/config.js';
import { gracefulShutdownSync } from '../../brain_flowork_utils/gracefulShutdown.js';
import { getSecureStorage } from '../../brain_flowork_utils/secureStorage/index.js';
import { clearToolSchemaCache } from '../../brain_flowork_utils/toolSchemaCache.js';
import { resetUserCache } from '../../brain_flowork_utils/user.js';
...
export async function call(): Promise<React.ReactNode> {
  ...
  const message = <Text>Successfully logged out from your FloworkOS account.</Text>;
  setTimeout(() => {
